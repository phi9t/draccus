...
check "draccus-run PATH includes spack bin" "grep -qF '/opt/draccus/spack/bin' \"$DRACCUS_BUNDLE/bin/draccus-run\""
check "draccus-run PATH includes starship cache bin" "grep -qF '/opt/draccus/cache/starship/bin' \"$DRACCUS_BUNDLE/bin/draccus-run\""
...
check "draccus-run disables Spack locks for readonly inspection" "grep -qF 'SPACK_USER_CONFIG_PATH /opt/draccus/cache/spack-readonly-config' \"$DRACCUS_BUNDLE/bin/draccus-run\""
check "draccus-run mirrors Spack env metadata for readonly activation" "grep -qF 'spack-readonly-envs' \"$DRACCUS_BUNDLE/bin/draccus-run\""
...
check "draccus-run exports base-ml PYTHONPATH" "grep -qF '/opt/draccus/view/base-ml/lib/python3.12/site-packages' \"$DRACCUS_BUNDLE/bin/draccus-run\""
